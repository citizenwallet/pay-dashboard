...
export default function AddItem({
    ...
    const handleNewItemFormChange = (field: string, value: string | File | null) => {
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => handleNewItemFormChange('name', e.target.value)}
                            />
                        </div>
                        ...
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                onChange={(e) => handleNewItemFormChange('category', e.target.value)}
                            />
                        </div>
